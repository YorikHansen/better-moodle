...
// @require         https://unpkg.com/darkreader@4.9.86/darkreader.js#sha512=6792b51c55273b96edc7d87f1180832cc321561d7f885004da58e660f53a7684f69e63d0aef1e2c5cc3313949ef1e16963ad420cec8595de391152156dc75b69
...
const createSidebar = (id, position, icon, callback) => {
    // TODO: Add in div for left/right
...
const SETTINGS = [
    ...
    new SelectSetting('general.prideLogo', 'rotated', [
        'off',
        'rotated',
        'horizontal',
        'agender',
...
if (typeof prideLogoSetting.value === 'boolean') {
    prideLogoSetting.value = prideLogoSetting.value ? 'rotated' : 'off';
}
if (prideLogoSetting.value !== 'off') {
    ready(() => {
        ...
        switch (getSetting('general.prideLogo')) {
            case 'rotated': // 11 % margin-top-left
                GM_addStyle(css`
                    .navbar.fixed-top .navbar-brand .logo,
                    #logoimage {
                        background-image: linear-gradient(
